...
:: ============================================================================
:: FiveM Mod Uninstaller - Uninstall Script (Recursive)
:: ============================================================================
:: This script will recursively find the first .rpf file in this folder 
:: (or subfolders) and remove it from %localappdata%\FiveM\FiveM.app\mods
:: ============================================================================

title FiveM Mod Uninstaller
...
:found_installer
:: Run the uninstaller
"%INSTALLER%" --uninstall-oiv "%RPF_FILE%"
